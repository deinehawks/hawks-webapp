          ...
          columns={[
            {
              header: "Code",
              cell: (row) => (
                <DetailLink href={`/admin/clients/${row.id}`}>
                  {row.code}
                </DetailLink>
              ),
            },
          ...
          columns={[
            {
              header: "Email",
              cell: (row) => (
                <DetailLink href={`/admin/profiles/${row.id}`}>
                  {row.email ?? "No email"}
                </DetailLink>
              ),
            },
          ...
          columns={[
            {
              header: "Name",
              cell: (row) => (
                <DetailLink href={`/admin/organizations/${row.id}`}>
                  {row.name}
                </DetailLink>
              ),
            },
          ...
          columns={[
            {
              header: "Name",
              cell: (row) => (
                <DetailLink href={`/admin/people/${row.id}`}>
          ...
          columns={[
            {
              header: "Name",
              cell: (row) => (
                <DetailLink href={`/admin/farms/${row.id}`}>
                  {row.name}
                </DetailLink>
              ),
            },
          ...
          columns={[
            {
              header: "User Account",
              cell: (row) => (
                <DetailLink href={`/admin/memberships/${row.id}`}>
          ...
          columns={[
            {
              header: "Title",
              cell: (row) => (
                <DetailLink href={`/admin/outputs/${row.id}`}>
